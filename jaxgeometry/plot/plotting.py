...
def newfig2d(nrows:int=1,ncols:int=1,plot_number:int=1,new_figure:bool=True)->Tuple[matplotlib.figure.Figure]:
    if new_figure:
        fig = plt.figure()
    else:
        fig = plt.gcf()
    plt.axis("equal")
    return (fig)
def newfig3d(nrows:int=1,ncols:int=1,plot_number:int=1,new_figure:bool=True)->Tuple[matplotlib.figure.Figure,
                                                                                    plt.Axes]:
    if new_figure:
        fig = plt.figure()
    else:
...
def plot_density_estimate(M:object, 
                          obss:Tuple[Array, Array], 
                          alpha:float=.2, 
...
def plot_f(M:object, 
           f:Callable[Tuple[Array, Array], Array], 
...
def plot_sphere_density_estimate(M:object, 
                                 obss_M:Tuple[Array, Array], 
                                 alpha:float=.2, 
                                 bandwidth:float=0.08, 
                                 pts:int=100, 
                                 cmap = cm.jet
...
def plot_Euclidean_density_estimate(obss:Array, 
                                    alpha:float=.2, 
                                    view:str='2D', 
                                    limits:List[float]=None,
                                    border:float=1.5, 
