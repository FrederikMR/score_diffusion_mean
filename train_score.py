...
def train_sn_s1(file_path:str = 'models/S', 
                N:int=2, 
                loss_type:str='vsm',
                max_T:float=1.0,
                lr_rate:float=0.01,
    ...
    def tmx_fun(params:hk.Params, state_val:dict, rng_key:Array, x0:jnp.ndarray, 
        ...
        return jnp.dot(M.invJF((Fx,x[1])),
                          model.apply(params, rng_key,jnp.hstack((x0,Fx,t))))
    
    @hk.transform
    def model(x):
        
        score = SN_s1(M.emb_dim)
...
def train_sn_s2(file_path:str = 'models/S', 
                N:int=2, 
                gamma:float=1.0,
                max_T:float=1.0,
                lr_rate:float=0.0002,
    ...
    state = load_model(''.join(('models/S',str(N),'/dsm/')))
    rng_key = jran.PRNGKey(2712)
    s1 = lambda x,y,t: s1_model.apply(state.params,rng_key, jnp.hstack((x, y, t)))
...
def train_ellipsoid_s1(file_path:str = 'models/Ellipsoid', 
                N:int=2, 
                loss_type:str='vsm',
                max_T:float=1.0,
                lr_rate:float=0.01,
...
def train_ellipsoid_s2(file_path:str = 'models/S', 
                N:int=2, 
                gamma:float=1.0,
                max_T:float=1.0,
                lr_rate:float=0.0002,
...
def train_cylinder_s1(file_path:str = 'models/Cylinder', 
                loss_type:str='vsm',
                max_T:float=1.0,
                lr_rate:float=0.01,
                epochs:int=50000,
    ...
    def model(x):
        ...
        score = Cylinder_s1(M.emb_dim)
        
        return score(x)
    
    file_path = ''.join((file_path,'/',loss_type,'/'))
    N_sim = x_samples*repeats
...
def train_cylinder_s2(file_path:str = 'models/S', 
                N:int=2, 
                gamma:float=1.0,
                max_T:float=1.0,
                lr_rate:float=0.0002,
...
def train_s1_s1(file_path:str = 'models/S1', 
                loss_type:str='vsm',
                max_T:float=1.0,
                lr_rate:float=0.01,
                epochs:int=50000,
    ...
    def tmx_fun(params:hk.Params, state_val:dict, rng_key:Array, x0:jnp.ndarray, 
        ...
        return jnp.dot(M.invJF((Fx,x[1])),
                          model.apply(params, rng_key,jnp.hstack((x0,Fx,t)))).reshape(1)
    
    @hk.transform
    def model(x):
        
        score = S1_s1(M.emb_dim)
...
def train_S1_s2(file_path:str = 'models/S', 
                N:int=2, 
                gamma:float=1.0,
                max_T:float=1.0,
                lr_rate:float=0.0002,
...
def train_torus_s1(file_path:str = 'models/Torus', 
                   loss_type:str='vsm',
                   max_T:float=1.0,
                   lr_rate:float=0.01,
                   epochs:int=50000,
...
def train_torus_s2(file_path:str = 'models/S', 
                N:int=2, 
                gamma:float=1.0,
                max_T:float=1.0,
                lr_rate:float=0.0002,
...
def train_H2_s1(file_path:str = 'models/H2', 
                   loss_type:str='vsm',
                   max_T:float=1.0,
                   lr_rate:float=0.01,
                   epochs:int=50000,
...
def train_H2_s2(file_path:str = 'models/S', 
                N:int=2, 
                gamma:float=1.0,
                max_T:float=1.0,
                lr_rate:float=0.0002,
...
def train_landmarks_s1(file_path:str = 'models/Landmarks', 
                       N:int=2,
                       m:int=2,
                       loss_type:str='vsm',
                       max_T:float=1.0,
...
def train_landmarks_s2(file_path:str = 'models/Landmarks', 
                N:int=2, 
                gamma:float=1.0,
                max_T:float=1.0,
                lr_rate:float=0.0002,
...
def train_heisenberg_s1(file_path:str = 'models/Heisenberg', 
                       loss_type:str='dsm',
                       max_T:float=1.0,
                       lr_rate:float=0.01,
                       epochs:int=50000,
...
def train_heisenberg_s2(file_path:str = 'models/Landmarks', 
                N:int=2, 
                gamma:float=1.0,
                max_T:float=1.0,
                lr_rate:float=0.0002,
...
def train_spdn_s1(file_path:str = 'models/SPDN',
                N:int = 2,
                loss_type:str='dsm',
                max_T:float=1.0,
                lr_rate:float=0.01,
...
def train_spdn_s2(file_path:str = 'models/R', 
                N:int=2, 
                gamma:float=1.0,
                max_T:float=1.0,
                lr_rate:float=0.0002,
...
if __name__ == '__main__':
    ...
    if args.model == "RN":
        ...
        if args.order == "s2":
            train_sn_s2(file_path = 'models/S', 
                            N=args.dim, 
                            gamma=1.0,
                            max_T=1.0,
                            lr_rate=0.0002,
            ...
            train_sn_s1(file_path='models/S', 
                        N=args.dim, 
                        loss_type='dsm',
                        max_T=1.0,
                        lr_rate=0.0002,
        ...
        if args.order == "s2":
            train_sn_s2(file_path = 'models/S1', 
                            gamma=1.0,
                            max_T=1.0,
                            lr_rate=0.0002,
                            epochs=50000,
            ...
            train_sn_s1(file_path='models/S1', 
                        loss_type='dsm',
                        max_T=1.0,
                        lr_rate=0.0002,
                        epochs=50000,
                        ...
                        save_step=10,
                        seed=2712)
    elif args.model == "Ellipsoid":
        if args.order == "s2":
            train_ellipsoid_s2(file_path = 'models/Ellipsoid', 
                            N=args.dim, 
                            gamma=1.0,
                            max_T=1.0,
                            lr_rate=0.0002,
            ...
            train_ellipsoid_s1(file_path='models/Ellipsoid', 
                        N=args.dim, 
                        loss_type='dsm',
                        max_T=1.0,
                        lr_rate=0.0002,
                        ...
                        save_step=10,
                        seed=2712)
    elif args.model == "Cylinder":
        if args.order == "s2":
            train_cylinder_s2(file_path = 'models/Cylinder', 
                            gamma=1.0,
                            max_T=1.0,
                            lr_rate=0.0002,
                            epochs=50000,
            ...
            train_cylinder_s1(file_path='models/Cylinder', 
                        loss_type='dsm',
                        max_T=1.0,
                        lr_rate=0.0002,
                        epochs=50000,
                        ...
                        save_step=10,
                        seed=2712)
    elif args.model == "Torus":
        if args.order == "s2":
            train_torus_s2(file_path = 'models/Torus', 
                            gamma=1.0,
                            max_T=1.0,
                            lr_rate=0.0002,
                            epochs=50000,
            ...
            train_torus_s1(file_path='models/Torus', 
                        loss_type='dsm',
                        max_T=1.0,
                        lr_rate=0.0002,
                        epochs=50000,
